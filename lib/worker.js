...
var Worker = function (_events$EventEmitter) {
  _inherits(Worker, _events$EventEmitter);

  function Worker(queue, type, workerFn) {
  ...
  _createClass(Worker, [{
    ...
    value: function emit(name) {
      ...
      (_get2 = _get(Worker.prototype.__proto__ || Object.getPrototypeOf(Worker.prototype), 'emit', this)).call.apply(_get2, [this, name].concat(args));
    ...
    value: function _failJob(job) {
      ...
      return this.client.update({
        ...
        _this3.emit(_constants2.default.EVENT_WORKER_JOB_FAIL_ERROR, _this3._formatErrorParams(err, job));
        return false;
      });
    }
  }, {
